                        ...
                        <div className="gallery-panel general">
                            <div className="custom-select-container">
                                <div className="custom-select" data-select-type="job" data-default-value="general-job-1">
                                    ...
                                    <ul className="custom-select-options" role="listbox">
                                        ...
                                        <li><button type="button" className="custom-select-option" data-value="general-job-25" role="option">Dining Chair Refresh <span className="job-date">(Jan 2018)</span></button></li>
                            ...
                            <div className="job-panels-container">
                                ...
                                <div className="job-panel" data-job="general-job-18">
                                    <div className="gallery-text"><p>Removed a broken low-security back door lock and installed a new British Standard back door lock.</p></div>
                                    <div className="gallery-carousel">
                                        <div className="carousel-track">
