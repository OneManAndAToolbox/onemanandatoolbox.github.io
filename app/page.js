        ...
        <>
            ...
            <div className="container">
                        ...
                        <div className="gallery-panel general">
                            <div className="custom-select-container">
                                <div className="custom-select" data-select-type="job" data-default-value="general-job-2">
                                    ...
                                    <ul className="custom-select-options" role="listbox">
                                        <li><button type="button" className="custom-select-option" data-value="general-job-2" role="option">Exterior Refresh <span className="job-date">(Jan 2024)</span></button></li>
                        ...
                        <div className="gallery-panel carpentry">
                            ...
                            <div className="job-panels-container">
                                <div className="job-panel" data-job="carpentry-job-2">
                                    <div className="gallery-text">
                                        <p>Constructed a floor-to-ceiling fitted wardrobe with custom interior storage solutions, including drawers, hanging rails, and shelving.</p>
                                    </div>
                                    <div className="gallery-carousel">
                                        <div className="carousel-track">
                                            <div className="carousel-slide"><img src="https://images.pexels.com/photos/271743/pexels-photo-271743.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800&amp;h=533&amp;dpr=1" alt="Custom Wardrobe 1" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="https://images.pexels.com/photos/1457845/pexels-photo-1457845.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800&amp;h=533&amp;dpr=1" alt="Custom Wardrobe 2" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="https://images.pexels.com/photos/1643389/pexels-photo-1643389.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=800&amp;h=533&amp;dpr=1" alt="Custom Wardrobe 3" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="gallery-panel landscaping">
                            ...
                            <div className="job-panels-container">
                                <div className="job-panel" data-job="landscaping-job-2">
                                    ...
                                    <div className="gallery-carousel">
                                        <div className="carousel-track">
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_pergola_(1).webp" alt="Pergola Sunbathing Platform 1" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_pergola_(2).webp" alt="Pergola Sunbathing Platform 2" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_pergola_(3).webp" alt="Pergola Sunbathing Platform 3" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_pergola_(4).webp" alt="Pergola Sunbathing Platform 4" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="job-panel" data-job="landscaping-job-1">
                                    ...
                                    <div className="gallery-carousel">
                                        <div className="carousel-track">
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_bike_lock_anchor_(1).webp" alt="Concrete Base & Bike Anchor 1" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_bike_lock_anchor_(2).webp" alt="Concrete Base & Bike Anchor 2" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_bike_lock_anchor_(3).webp" alt="Concrete Base & Bike Anchor 3" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_bike_lock_anchor_(4).webp" alt="Concrete Base & Bike Anchor 4" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                            <div className="carousel-slide"><img src="/OneManAndAToolbox/images/gmp/gmp_bike_lock_anchor_(5).webp" alt="Concrete Base & Bike Anchor 5" /> <span className="expand-hint"><i className="fas fa-search-plus"></i> <span className="hint-touch">Touch</span><span className="hint-click">Click</span><br />Picture to<br />Expand</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="contact">
                    ...
                    <p><strong>Mobile:</strong> <a href="tel:07700900000" className="contact-link">07700 900000</a></p>
                    <p><strong>Email:</strong> <a href="mailto:onemanandatoolbox@email.com" className="contact-link">onemanandatoolbox@email.com</a></p>
